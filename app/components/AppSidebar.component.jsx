  ...
  return (
    <>
      <button
        ...
        type="button"
        className={`absolute top-4 ${isCollapsed && !isHovering ? "left-[88px]" : "left-[298px]"}  p-2 rounded-md text-gray-800 hover:bg-gray-100 transition-all duration-200 cursor-pointer`}
      >
      ...
      >
        <div className="flex mt-4 justify-center items-center">
          {isCollapsed && !isHovering ? (
            <img src="/images/paw.png" alt="Logo" className="w-8 h-8 mt-4" />
          ) : (
            <img src="/icons/logo.svg" alt="Logo" className="h-16" />
          )}
        </div>
